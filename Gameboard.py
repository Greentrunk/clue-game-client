...
class Grid:
    ...
    def draw_grid_lines(self):
        for row in range(self.rows + 1):
            pygame.draw.line(self.screen, BLACK, (0, row * self.square_size),
                             (self.cols * self.square_size, row * self.square_size))
        for col in range(self.cols + 1):
            pygame.draw.line(self.screen, BLACK, (col * self.square_size, 0),
...
rooms = [roomLocations.STUDY, roomLocations.HALL, roomLocations.LOUNGE, roomLocations.LIBRARY,
...
possible_moves = [(customGrid.x1.value, customGrid.y1.value), (customGrid.x2.value, customGrid.y1.value),
                  ...
                  (customGrid.x3.value, customGrid.y2.value),
                  (customGrid.x5.value, customGrid.y2.value),
                  (customGrid.x1.value, customGrid.y3.value), (customGrid.x2.value, customGrid.y3.value),
                  (customGrid.x3.value, customGrid.y3.value), (customGrid.x4.value, customGrid.y3.value),
                  (customGrid.x5.value, customGrid.y3.value), (customGrid.x1.value, customGrid.y4.value),
                  (customGrid.x3.value, customGrid.y4.value),
                  (customGrid.x5.value, customGrid.y4.value), (customGrid.x1.value, customGrid.y5.value),
                  (customGrid.x2.value, customGrid.y5.value), (customGrid.x3.value, customGrid.y5.value),
                  (customGrid.x4.value, customGrid.y5.value), (customGrid.x5.value, customGrid.y5.value)
                  ]
